...
export const com = {
    ...
    BugReportData: 'body > div:nth-of-type(4)',
    GameLog: 'div#gamelog',
    GameChat: 'input#chatText',
    DeckInput: 'input#deckLink',
    CreateGameButton: 'button#quickCreateGame',
    ...
    MyDeckEmpty: 'div.my-deck.my-deck-empty',
    MyDeckCount: 'div.my-deck div a div:nth-of-type(2)',
    TheirDeckEmpty: 'div.their-deck.empty',
    TheirDeckCount: 'div.their-deck div a div:nth-of-type(2)',
    ...
    YourselfOrOpponentButton(choice:"Yourself"|"Opponent") { return `div#BUTTONINPUT div button:nth-of-type(${choice === "Yourself" ? 1 : 2})`; },
